"use strict";
const stations=[
{index:1,name:"SPACE 103.2",frequency:"103.2",videoId:"6TnV43UWoqk",startSeconds:3,logo:"space-103-2.png"},
...
{index:4,name:"WEST COAST CLASSICS",frequency:"95.6",videoId:"z0Wf3IuZnf0",logo:"west-coast-classics.png"},
{index:5,name:"REBEL RADIO",frequency:"89.5",videoId:"HeLsaX1I5B4",logo:"rebel-radio.png"},
{index:6,name:"THE LOWDOWN 91.1",frequency:"91.1",videoId:"RT9h-C24idQ",logo:"the-lowdown-91-1.png"},
{index:7,name:"BLUE ARK",frequency:"94.7",videoId:"LRdjhqMYSGg",logo:"blue-ark.png"},
...
{index:11,name:"RADIO MIRROR PARK",frequency:"88.9",videoId:"SDWHIACuuaQ",logo:"radio-mirror-park.png"},
{index:12,name:"SOULWAX FM",frequency:"93.7",videoId:"EhsQZl8BFz8",logo:"soulwax-fm.png"},
{index:13,name:"FLYLO FM",frequency:"98.3",videoId:"3P-ux63rHkU",logo:"flylo-fm.png"},
{index:14,name:"VINEWOOD BOULEVARD RADIO",frequency:"101.5",videoId:"5fnGyUc2eFs",logo:"vinewood-boulevard-radio.png"},
{index:15,name:"LOS SANTOS ROCK RADIO",frequency:"102.3",videoId:"Xy75nA56vcc",logo:"los-santos-rock-radio.png"},
{index:16,name:"LOS SANTOS UNDERGROUND RADIO",frequency:"90.3",videoId:"9cL6IDCtuzs",logo:"los-santos-underground.svg"},
{index:17,name:"iFRUIT RADIO",frequency:"107.9",videoId:"P3qixldzDow",logo:"ifruit-radio.svg"},
{index:18,name:"KULT FM",frequency:"99.1",videoId:"I2Xjuz-mnN0",logo:"kult-fm.svg"},
{index:19,name:"STILL SLIPPING LOS SANTOS",frequency:"96.2",videoId:"fpvJaphZ2_g",logo:"still-slipping.svg"},
{index:20,name:"THE MUSIC LOCKER",frequency:"102.8",videoId:"dBvMBYbUZFc",logo:"music-locker.svg"},
{index:21,name:"MEDIA PLAYER",frequency:"88.1",videoId:"dPkzYz-AYOs",logo:"media-player.svg"},
{index:22,name:"MOTOMAMI LOS SANTOS",frequency:"94.4",videoId:"30uA_Hppzpc",logo:"motomami.svg"},
{index:23,name:"BLONDED LOS SANTOS",frequency:"97.8",videoId:"-tVumJBaTWY",logo:"blonded.svg"}
];
